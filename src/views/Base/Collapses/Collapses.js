            ...
            <CCard>
              <CCardHeader>
                ...
                <CCardBody>
                  ...
                  <CRow>
                    <CCol>
                      <CCollapse show={this.state.collapseMulti[0]}>
                        <CCard>
                          <CCardBody>
                    ...
                    <CCol className="col-sm-12 col-md-6">
                      <CCollapse show={this.state.collapseMulti[1]}>
                        <CCard>
                          <CCardBody>
                            Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident.
                          </CCardBody>
              ...
              <CCardBody>
                <div id="exampleAccordion">
                  <div>
                    ...
                    <CCollapse show={this.state.custom[0]}>
                      <p className="mb-3">
                  ...
                  <div>
                    ...
                    <CCollapse show={this.state.custom[1]}>
                      <p className="mb-3">
