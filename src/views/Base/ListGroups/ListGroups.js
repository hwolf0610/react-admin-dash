            ...
            <CCard>
              ...
              <CCardBody>
                <CRow>
                  ...
                  <CCol xs="8">
                    <CTabContent>
                      <CTabPane active={this.state.activeTab === 0} >
                      ...
                      <CTabPane active={this.state.activeTab === 1}>
                      ...
                      <CTabPane active={this.state.activeTab === 2}>
                      ...
                      <CTabPane active={this.state.activeTab === 3}>
