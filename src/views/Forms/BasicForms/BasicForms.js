              ...
              <CCardBody>
                <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                  ...
                  {/* <CFormGroup row> */}
                    ...
                    <CCol xs="12" md="9">
                      <CInputFile custom id="custom-file-input" onChange={this.onChangeDividesCardFile}/>
                      <CLabel htmlFor="custom-file-input" variant="custom-file">
                       {this.state.fileName}
                      </CLabel>
                      <CButton type="button" color="info" >Upload Video</CButton>
                    </CCol>
                  {/* </CFormGroup> */}
          ...
          <CCol xs="12">
            <CFade timeout={this.state.timeout} in={this.state.fadeIn}>
              <CCard>
                ...
                <CCollapse show={this.state.collapse} timeout={1000} id="collapseExample">
                  <CCardBody>
                    <CForm className="form-horizontal">
                      <CFormGroup>
