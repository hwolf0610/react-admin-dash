                ...
                <CButtonGroup className="float-right mr-3">
                  {
                    ['Day', 'Month', 'Year'].map((value, key)=>(
                      <CButton
                        ...
                        key={key}
                        className="mx-0"
                        active={value === this.state.selected ? true : false}
                ...
                <CRow>
                  ...
                  <CCol xs="12" md="6" xl="6">
                    ...
                    <div className="divider text-center">
                      <CButton color="link" size="sm" className="text-muted" data-toggle="tooltip" data-placement="top"
                              title="" data-original-title="show more"><CIcon name="cil-options" /></CButton>
                    </div>
                ...
                <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-center">
                        <div className="c-avatar">
                          ...
                          <CBadge className="c-avatar-status" color="success">s</CBadge>
                        </div>
                      </td>
                      <td>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-us" className="h4 mb-0" title="us" id="us" />
                      </td>
                      <td>
                      ...
                      <td className="text-center">
                        <CIcon name="cib-mastercard" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                    ...
                    <tr>
                      <td className="text-center">
                        <div className="c-avatar">
                          ...
                          <CBadge className="c-avatar-status" color="danger"></CBadge>
                        </div>
                      </td>
                      <td>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-br" className="h4 mb-0" title="br" id="br" />
                      </td>
                      <td>
                        <div className="clearfix">
                          <div className="float-left">
                      ...
                      <td className="text-center">
                        <CIcon name="cib-visa" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                        <div className="small text-muted">Last login</div>
                    ...
                    <tr>
                      <td className="text-center">
                        <div className="c-avatar">
                          ...
                          <CBadge className="c-avatar-status" color="warning"></CBadge>
                        </div>
                      </td>
                      <td>
                        <div>Quintin Ed</div>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-in" className="h4 mb-0" title="in" id="in" />
                      </td>
                      <td>
                        <div className="clearfix">
                          <div className="float-left">
                      ...
                      <td className="text-center">
                        <CIcon name="cib-stripe" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                        <div className="small text-muted">Last login</div>
                    ...
                    <tr>
                      <td className="text-center">
                        <div className="c-avatar">
                          ...
                          <CBadge className="c-avatar-status" color="secondary"></CBadge>
                        </div>
                      </td>
                      <td>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-fr" className="h4 mb-0" title="fr" id="fr" />
                      </td>
                      <td>
                        <div className="clearfix">
                          <div className="float-left">
                      ...
                      <td className="text-center">
                        <CIcon name="cib-paypal" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                        <div className="small text-muted">Last login</div>
                    ...
                    <tr>
                      <td className="text-center">
                        <div className="c-avatar">
                          ...
                          <CBadge className="c-avatar-status" color="success"></CBadge>
                        </div>
                      </td>
                      <td>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-es" className="h4 mb-0" title="es" id="es" />
                      </td>
                      <td>
                        <div className="clearfix">
                          <div className="float-left">
                      ...
                      <td className="text-center">
                        <CIcon name="cil-wallet" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                        <div className="small text-muted">Last login</div>
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                        <CIcon name="cif-pl" className="h4 mb-0" title="pl" id="pl" />
                      </td>
                      <td>
                        <div className="clearfix">
                          <div className="float-left">
                      ...
                      <td className="text-center">
                        <CIcon name="cib-cc-amex" style={{ fontSize: 24 + 'px' }} />
                      </td>
                      <td>
                        <div className="small text-muted">Last login</div>
